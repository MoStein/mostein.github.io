...
var playerXPperLevel = 750;
var playerLevel = 1; // Da es nur einen Spieler gibt, ergibt sich noch nicht viel Sinn darin, für den Spieler ein interface (im Sinne der Programmierung) zu erstellen.
...
window.onload = function () {
    ...
    updatePlayerLevel();
    document.getElementById("Button 2").addEventListener("click", fightAllMonsters, false);
    document.getElementById("Button 3").addEventListener("click", fightAllWeakMonsters, false);
    document.getElementById("Button 4").addEventListener("click", fightWeakestMonster, false);
...
function generateMonster() {
    var newNr = getRNGNumber(3) + 1;
    for (var i = 0; i < newNr; i++) {
        ...
        var newMonsterLevel = generateMonsterLevel();
        var newMonsterHealthPoints = generateMonsterHealthPoints();
        var newMonster = {
...
function clearMonsterCell() {
    var monsterSheldon = document.getElementById(monsterHolder);
...
function monsterGenerateHTML(i) {
    ...
    monsterImg.setAttribute("src", monsterArray[i].monsterImage); // Der Pfad für das Bild muss über setAttribute festgelegt werden. Der Bildpfad kann natürlich auch anders aussehen.
...
function generateMonsterXP() {
    ...
    var tempMonsterXP = 100 + getRNGNumber(999);
